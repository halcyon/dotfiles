...
(fn &optional WORD)" t nil) (if (fboundp 'register-definition-prefixes) (register-definition-prefixes "dictionary" '("dictionary-"))) (provide 'dictionary-autoloads)) "rfc-mode" ((rfc-mode rfc-mode-autoloads) (autoload 'rfc-mode-read "rfc-mode" "Read the RFC document NUMBER.
